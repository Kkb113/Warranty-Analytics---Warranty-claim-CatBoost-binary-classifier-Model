...
calibration or ensemble falls back to the already accepted Phase 12 score
policy; no post-validation search is performed.
...
Publication is atomic. The validator regenerates fold assignments, calibration
metrics, final calibrators, ensemble summaries, thresholds, and validation
probabilities. TEST target rows, predictions, and metrics remain sealed until
Phase 15.
